...
class CashierShift extends CI_Controller {
    ...
    public function index(){
		...
		$this->load->view('cashier_shift', $result);

	}

    public function checkCashierShift() {
        $response = $this->CashierShiftinfo->checkCashierShift($this->api_token,[]);
    ...
    public function startCashierShift() {
        ...
        $response = $this->CashierShiftinfo->startCashierShift($this->api_token,$form_data);
    ...
    public function closeCashierShift() {
        $check_cashier_shift = $this->CashierShiftinfo->checkCashierShift($this->api_token,[]);
        ...
        $response = $this->CashierShiftinfo->closeCashierShift($this->api_token, $data);
    ...
    public function getCashierShiftRecDetails($id) {
        $response = $this->CashierShiftinfo->getCashierShiftRecDetails($this->api_token,$id);
		echo json_encode($response);
    }
    ...
    public function updateShiftOpeningBalances() {
        ...
        $response = $this->CashierShiftinfo->updateShiftOpeningBalances($this->api_token, $data);
