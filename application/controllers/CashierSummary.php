...
class CashierSummary extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('CashierSummaryinfo');
    ...
    public function index() {
        ...
        $result['shift_summaries'] = $this->CashierSummaryinfo->getShiftSummaries($this->api_token,[]);

        $this->load->view('cashier_shift_summary', $result);
    }
}
