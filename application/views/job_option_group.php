        	...
        	<div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        		<div class="modal-content">
                            ...
                            <div class="col-4">
                            	<form action="<?php echo base_url() ?>JobOptionGroup/jobOptionGroupInsertUpdate"
                            		...
                            		<div class="form-group mb-1">
                                        ...
                                        <button type="button" id="cancellistBtn" class="btn btn-warning btn-sm px-4 mt-auto p-2 d-none" onclick="cancelBtn();">
        			...
        			<div class="modal-footer">
        				<button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-window-close mr-2"></i>Close</button>
        			</div>
        		</div>
        	</div>
        </div>
