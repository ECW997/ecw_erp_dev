    ...
    <header>
        <table>
            <tr>
                ...
                <th colspan="3" style="width:83%;font-size:14px;font-weight:500;" class="header_th">
                    <table style="width:100%;">
                        <tr>
                            <td style="text-align:right;">TAX INVOICE</td>
            ...
            <tr>
                ...
                <th style="width:10%;" class="header_th"><span> :
                    </span><?= date('d/m/Y',strtotime($main_data['invoice_date'])) ?></th>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <th style="width:20%;" class="header_th"><span> : </span><?= $main_data['vehicle_number'] ?? 'N/A' ?>
                </th>
                <th style="width:10%;" class="header_th">Invoice Type</th>
                <th style="width:10%;" class="header_th"><span> :
                    </span><?= $main_data['invoice_type'] == 'direct' ? 'Direct' : 'JobCard' ?></th>
            </tr>
            <?php endif; ?>
            <tr>
                ...
                <th style="width:10%; vertical-align: bottom;" class="header_th"><span> :
                    </span><?= $main_data['real_jobcard_no'] ?? '' ?></th>
            </tr>

            <tr>
                <th style="width:10%;" class="header_th">VAT Reg.No</th>
                <th style="width:10%;" class="header_th"><span> : </span><?= $main_data['vat_number'] ?></th>
                <th style="width:10%;" class="header_th" colspan="1" style="vertical-align: bottom;">Our VAT No</th>
                <th style="width:10%; vertical-align: bottom;" class="header_th"><span> : </span>114623210-7000</th>
            </tr>
        </table>
    </header>
    ...
    <div style="margin-bottom: 20px;">
        ...
        <div style="margin-top:10px;border-top: 1.5px solid #000;">
            <table>
				...
				$vat_amount = (float)($main_data['inv_total_tax'] ?? 0);
				$finalized_gross_total = $inv_gross_total - $vat_amount;
				$add_vat_status = $main_data['inv_add_vat'] ?? 0;
				...
				// $total_net_balance = ($grand_total - $total_paid)+ $vat_amount;
				$total_net_balance = ($add_vat_status == 1)
					? (($grand_total - $total_paid) + $vat_amount)
                        ...
                        <table style="width:100%;">
                            <tr>
                                ...
                                <td class="datatable_data_td" style="width:30%; text-align:right;">
                                    <?= number_format($finalized_gross_total ?? 0, 2) ?>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="datatable_data_td" style="width:60%;">
                                    VAT(<?= isset($main_data['inv_tax_pc']) ? $main_data['inv_tax_pc'] . '%' : '0%' ?>)
                                </td>
                                <td class="datatable_data_td" style="width:10%; text-align:center;">:</td>
                                <td class="datatable_data_td" style="width:30%; text-align:right;">
                                    <?= number_format($vat_amount ?? 0, 2) ?>
                                </td>
                            </tr>
                            <tr>
