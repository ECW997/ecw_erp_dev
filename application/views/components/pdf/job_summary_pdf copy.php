                ...
                foreach ($item['details'] as $joblist):
                    ...
                    <tr>
                        ...
                        <td class="datatable_data_td" style="width:46%; text-align:left;">
                            <?= $item['job_sub_category_text'] ?? 'N/A' ?> - <?= $joblist['option_group_text'] ?? 'N/A' ?> - <?= $joblist['combined_option'] ?? 'N/A' ?>
                        </td>
                        <td class="datatable_data_td" style="width:5%; text-align:center;"><?= $joblist['qty'] ?? 0 ?></td>
                        <td class="datatable_data_td" style="width:10%; text-align:center;">EA</td>
                        <td class="datatable_data_td" style="width:13%; text-align:right;">
                            <?= number_format($joblist['rate'] ?? 0, 2) ?>
                        </td>
                        <td class="datatable_data_td" style="width:8%; text-align:center;">
                            <?= number_format($joblist['discount'] ?? 0, 2) ?>
                        </td>
                        <td class="datatable_data_td" style="width:15%; text-align:right;">
                            <?= number_format(($joblist['qty'] ?? 0) * ($joblist['rate'] ?? 0) * (1 - ($joblist['discount'] ?? 0)/100), 2) ?>
                        </td>
                    </tr>
                    <?php
                    
                    if ($count % 11 == 0 && $count < $totalRows) {
                        echo '
    ...
    <table style="table-layout: fixed;padding:3px;width:100%;border-collapse: collapse;">
    	...
    	<tr>
    		...
    		<td style="width:15%;text-align:right;border-top: 1px solid #000; border-bottom: 3px double #000;"
    			class="datatable_data_td">438,000.00</td>
    	</tr>
    </table>
    </div>
