    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content rounded-4">
            <div class="modal-header bg-info">
                ...
                <button type="button" class="btn-close btn-close-white addJobItemCloseBtn" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-12 col-md-3 d-flex align-items-center mb-2 mb-md-0">
                        ...
                        <select class="form-control form-control-sm required-field" id="price_category"
                            name="price_category" required>
                ...
                <form action="" id="jobCardForm">
                    <div class="mb-3">
                        <p class="mb-0">
                            <a class="jobSubItem text-info" data-toggle="collapse" href="#collapseExample1"
                    ...
                    <div class="mb-3">
                        <p class="mb-0">
                            <a class="jobSubItem text-info" data-toggle="collapse" href="#collapseExample2"
