...
if($functionmenu2=='Useraccount'){
    ...
    $approve1check=checkprivilege($menuprivilegearray, 20, 5);
    $approve2check=checkprivilege($menuprivilegearray, 20, 6);
    $approve3check=checkprivilege($menuprivilegearray, 20, 7);
