            ...
            <div class="container-fluid mt-2 p-0 p-2">
                <div class="card">
                    <div class="card-body p-0 p-2">
                        <div class="row">
                            <div class="col-3">
                                <form action="<?php echo base_url() ?>Vehicle_brand/Vehicle_brandinsertupdate"
                                    ...
                                    <div class="form-group mb-1">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="brand_name" 
                                            id="brand_name" data-field="brand_name" onkeyup="checkedDublicate(this)" required>
        ...
        "columns": [{
            ...
            },
            {
                ...
                "render": function(data, type, full) {
                    ...
                    button += '" id="' + full['idtbl_vehicle_brand'] +
                        '"><i class="fas fa-pen"></i></button>';
                    if (full['status'] == 1) {
                        button +=
                            '<a href="<?php echo base_url() ?>Vehicle_brand/Vehicle_brandstatus/' +
                            full['idtbl_vehicle_brand'] +
    ...
    $('#dataTable tbody').on('click', '.btnEdit', function() {
        ...
        if (r == true) {
            ...
            $.ajax({
                ...
                url: '<?php echo base_url() ?>Vehicle_brand/Vehicle_brandedit',
