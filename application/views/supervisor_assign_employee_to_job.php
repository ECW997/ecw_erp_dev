...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        		...
        		<div class="container-fluid">
        			<div class="page-header-content py-3">
        				<h1 class="page-header-title">
        					...
        					<span>Supervisor Assign Employee To Job</span>
        				</h1>
        			</div>
        		</div>
        	</div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="assignModalCenter" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="viewModalLongTitle">Assign Employees</h5>
                        ...
                        <form id="mainform_id" autocomplete="off">
                            ...
                            <div class="row mt-3">
                                <div class="col-12 d-flex align-content-end justify-content-end">
                                    <button type="button" id="submitbtn" class="btn btn-primary btn-sm px-4"><i
    ...
    $(document).ready(function() {
        ...
        $('#dataTable').DataTable({
            ...
            "columns": [
                ...
                {
                    "data": "emp_assign_status",
                    "render": function(data, type, full) {
                        if (full['emp_assign_status'] == 1) {
                            return 'Assigned';
                        } else {
                            return 'Not Assign'; 
                        }
                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        ...
                        button+='<button title="Assign & Edit" class="btn btn-primary btn-sm btnAdd_Edit mr-1 ';if(editcheck!=1){button+='d-none';}button+='" id="'+full['idtbl_jobcard']+'" emp_assign_status="'+full['emp_assign_status']+'" assign_id="'+full['idtbl_assign_emp_to_job']+'"><i class="fas fa-pen"></i></button>';
                        if(full['status']==1){
                            button+='<a title="Deactive" href="<?php echo base_url() ?>AssignEmployeeToJob/AssignEmployeeToJobstatus/'+full['idtbl_jobcard']+'/2" onclick="return deactive_confirm()" target="_self" class="btn btn-success btn-sm mr-1 ';if(statuscheck!=1){button+='d-none';}button+='"><i class="fas fa-check"></i></a>';
                        }else{
                            button+='<a title="Active" href="<?php echo base_url() ?>AssignEmployeeToJob/AssignEmployeeToJobstatus/'+full['idtbl_jobcard']+'/1" onclick="return active_confirm()" target="_self" class="btn btn-warning btn-sm mr-1 ';if(statuscheck!=1){button+='d-none';}button+='"><i class="fas fa-times"></i></a>';
                        }
                        button+='<a title="Delete" href="<?php echo base_url() ?>AssignEmployeeToJob/AssignEmployeeToJobstatus/'+full['idtbl_jobcard']+'/3" onclick="return delete_confirm()" target="_self" class="btn btn-danger btn-sm ';if(deletecheck!=1){button+='d-none';}button+='"><i class="fas fa-trash-alt"></i></a>';
        ...
        $(document).on('click', '.btnAdd_Edit', function () {
            var id = $(this).attr('id');
            $('#job_card_number').val(id);
            var emp_assign_status = $(this).attr('emp_assign_status');
            if(emp_assign_status == 0){
                if(id){
                    $.ajax({
                        type: "POST",
                        data: {
            ...
            }else if(emp_assign_status == 1){
                var r = confirm("Are you sure, You want to Edit this ? ");
                if (r == true) {
                    var id = $(this).attr('assign_id');
                    $.ajax({
                        type: "POST",
                        data: {
                            recordID: id
