            ...
            <div class="container-fluid mt-2 p-0 p-2">
                <div class="card">
                    <div class="card-body p-0 p-2">
                        <div class="row">
                            <div class="col-3">
                                <form action="<?php echo base_url() ?>Vehicle_type/Vehicle_typeinsertupdate"
                                    ...
                                    <div class="form-group mb-1">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="type_name"
                                            id="type_name" data-field="vehicle_type_name" onkeyup="checkedDublicate(this)" required>
                                        <div id="vehicle_type_name_errorMsg" style="color: red; display: none;font-size: 0.8rem;"></div>
                                    </div>
...
$(document).ready(function() {
    ...
    $('#dataTable').DataTable({
        ...
        ajax: {
            url: "<?php echo base_url() ?>scripts/vehicletypelist.php",
        ...
        "columns": [{
            ...
            },
            {
                ...
                "render": function(data, type, full) {
                    ...
                    button += '" id="' + full['idtbl_vehicle_type'] +
                        '"><i class="fas fa-pen"></i></button>';
                    if (full['status'] == 1) {
                        button +=
                            '<a href="<?php echo base_url() ?>Vehicle_type/Vehicle_typestatus/' +
                            full['idtbl_vehicle_type'] +
...
function checkedDublicate(input) {
    ...
    var tablename = 'tbl_vehicle_type';
