                            ...
                            <div class="col-3">
                                <form action="<?php echo base_url() ?>Employee/Employeeinsertupdate" method="post" autocomplete="off">
                                    <div class="form-group mb-1">
                                        <label class="small font-weight-bold">Item Category Name*</label>
                                        <input type="text" class="form-control form-control-sm" name="itemcategory_name" id="itemcategory_name" required>
                                    </div>
