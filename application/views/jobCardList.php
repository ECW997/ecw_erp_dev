    ...
    <div id="layoutSidenav_content">
        <main>
            ...
            <div class="container-fluid mt-2 p-0 p-2">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 col-md-9 d-flex align-items-center justify-content-end flex-wrap">
                                ...
                                <div class="d-flex align-items-center mr-3 mb-2 mb-md-0">
                                    ...
                                    <select id="job_status" class="custom-select custom-select-sm"
                                        style="min-width: 130px;">
                                        <option value="">All</option>
                                ...
                                <div class="d-flex align-items-center mr-3 mb-2 mb-md-0">
                                    ...
                                    <select id="payment_status" class="custom-select custom-select-sm"
                                        style="min-width: 130px;">
                                        <option value="">All Status</option>
                ...
                <!-- <table class="table table-bordered table-striped table-sm mt-4 d-none" id="jobCardExcelTable">
                  <thead>
                    <tr>
                      <th>Date</th>
                      <th>Vehicle No</th>
                  ...
                  <tbody id="jobCardExcelPreview"></tbody>
                </table> -->
            </div>
        </main>
    ...
    $(document).on('click', '.detailStatusBtn', function() {
        ...
        if (r == true) {
            ...
            $.ajax({
                type: "PUT",
                dataType: 'json',
                url: '<?php echo base_url() ?>JobOptionGroup/jobOptionGroupStatus/' + id + '/' +
                    status,
                success: function(result) {
                    if (result.status) {
