                ...
                <div class="container-fluid">
                    <div class="page-header-content py-3">
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-2"><h2 class="job-header-title">Mr. Harshana Lakmal </h2></div>
                            <div class="col-2"><h2 class="job-header-title">CAB-4455</h2></div>
                            <div class="col-2"><h2 class="job-header-title">Toyota - Prado</h2></div>
                            <div class="col-2"><h2 class="job-header-title text-primary">JCN-2503-1012</h2></div>
                        </div>
