            ...
            <div class="container-fluid mt-2 p-0 p-2">
                <div class="card">
                    <div class="card-body p-0 p-2">
                        <div class="row">
                            <div class="col-3">
                                <form action="<?php echo base_url() ?>Jobs/Jobsinsertupdate" method="post"
                                    autocomplete="off">
                                    <div class="form-group mb-1">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="job_name"
                                            id="job_name" data-field="job_name" onkeyup="checkedDublicate(this)"
                                            required>
                                        <div id="job_name_errorMsg"
...
$(document).ready(function() {
    ...
    $('#dataTable').DataTable({
        ...
        ajax: {
            url: "<?php echo base_url() ?>scripts/jobslist.php",
        ...
        "columns": [{
            ...
            },
            {
                ...
                "render": function(data, type, full) {
                    ...
                    button += '" id="' + full['idtbl_jobs'] +
                        '"><i class="fas fa-pen"></i></button>';
                    if (full['status'] == 1) {
                        button += '<a href="<?php echo base_url() ?>Jobs/Jobsstatus/' + full[
                                'idtbl_jobs'] +
    ...
    $('#dataTable tbody').on('click', '.btnEdit', function() {
        ...
        if (r == true) {
            ...
            $.ajax({
                ...
                url: '<?php echo base_url() ?>Jobs/Jobsedit',
