            ...
            <div class="container-fluid mt-2 p-0 p-2">
                <div class="card">
                    <div class="card-body p-0 p-2">
                        <div class="row">
                            <div class="col-3">
                                <form action="<?php echo base_url() ?>Vehicle_year/Vehicle_yearinsertupdate"
                                    method="post" autocomplete="off">
                                    <div class="form-group mb-1">
                                        <label class="small font-weight-bold">Vehicle Year*</label>
                                        <input type="text" class="form-control form-control-sm" name="year_name"
                                            id="year_name" data-field="year_name" onkeyup="checkedDublicate(this)" required>
                                        <div id="year_name_errorMsg" style="color: red; display: none;font-size: 0.8rem;"></div>
                                    </div>
...
$(document).ready(function() {
    ...
    $('#dataTable').DataTable({
        ...
        ajax: {
            url: "<?php echo base_url() ?>scripts/vehicleyearlist.php",
        ...
        "columns": [{
            ...
            },
            {
                ...
                "render": function(data, type, full) {
                    ...
                    button += '" id="' + full['idtbl_vehicle_year'] +
                        '"><i class="fas fa-pen"></i></button>';
                    if (full['status'] == 1) {
                        button +=
                            '<a href="<?php echo base_url() ?>Vehicle_year/Vehicle_yearstatus/' +
                            full['idtbl_vehicle_year'] +
