                    ...
                    <div class="card-body p-3">
                            ...
                            <div class="col-12">
                                <div class="control-panel">
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-md-6">
                                            <label for="confirmedOrderValue" class="form-label">Confirmed Order Value
                                                (Price)</label>
                                            <input type="number" class="form-control" id="confirmedOrderValue"
                                                ...
                                                placeholder="Enter order value/price" min="0" step="0.01"
                                                onkeyup="updatePriceSummary()" <?= $is_approve ? 'disabled' : ''; ?>>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 d-flex align-items-center justify-content-end">
                                <span class="badge bg-success">This order has been approved and cannot be
                                    modified.</span>
                            </div>
                            <?php else: ?>
                            <div class="col-md-4 d-flex align-items-center justify-content-end">
...
function moveToAvailable(jobId) {
    ...
    if (jobIndex !== -1) {
        ...
        renderTables();
        updatePriceSummary();
        $(`#availableJobsTable tbody tr[data-job-id="${jobId}"]`).addClass('table-warning').delay(500).queue(
            function() {
