            ...
            <div class="container-fluid mt-2 p-0 p-2">
                <div class="card">
                    <div class="card-body p-0 p-2">
                        <div class="row">
                            <div class="col-3">
                                <form action="<?php echo base_url() ?>MainJobCategory/mainJobCategoryInsert"
                                    method="post" autocomplete="off">
                                    <div class="form-group mb-1">
                                        <label class="small font-weight-bold text-dark">Main Job Category*</label>
                                        <input type="text" class="form-control form-control-sm" name="main_job_category"
...
$(document).ready(function() {
    ...
    $('#dataTable').DataTable({
        ...
        "buttons": [{
                ...
                title: 'Main Job Category Information',
    ...
    $('#dataTable tbody').on('click', '.btnEdit', function() {
        ...
        if (r == true) {
            ...
            $.ajax({
                type: "GET",
                dataType: 'json',
                url: '<?php echo base_url() ?>MainJobCategory/mainJobCategoryEdit/' + id,
                success: function(result) {
                    if (result.status == true) {
                        $('#recordID').val(result.data.id);
                        $('#main_job_category').val(result.data.name);
