...
class JobCardinfo extends CI_Model{
    ...
    public function getPaymentMethod($api_token,$form_data) {
        $headers = get_api_headers($api_token);
        return call_api('POST', 'get_sel2_payment_method_v1', $form_data, $headers);
    }


     public function getAuthorizedPersons($api_token,$form_data) {
        $headers = get_api_headers($api_token);
        return call_api('POST', 'get_sel2_discount_authorized_persons_v1', $form_data, $headers);
    }
    ...
    public function editJobCard($api_token,$form_data) {
        $headers = get_api_headers($api_token);
        return call_api('POST', 'job_card_v1', $form_data, $headers);
    }
    ...
    public function exportJobCardExcelData($api_token,$form_data) {
        $headers = get_api_headers($api_token);
        return call_api('POST', 'exportJobCardExcelData_v1', $form_data, $headers);
    }

     public function exportJobCardcategoryData($api_token,$form_data) {
        $headers = get_api_headers($api_token);
        return call_api('POST', 'exportJobCardSummaryData_v1', $form_data, $headers);
    }
