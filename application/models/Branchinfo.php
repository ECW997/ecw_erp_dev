<?php
class Branchinfo extends CI_Model{
    ...
    public function Branchedit(){
        ...
        $obj->branch_name=$respond->row(0)->branch;
        $obj->company_id=$respond->row(0)->tbl_company_idtbl_company;
        $obj->code=$respond->row(0)->code;
        $obj->address=$respond->row(0)->address1;
