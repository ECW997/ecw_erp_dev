<?php
class Materialinfo extends CI_Model{
    ...
    public function Materialinsertupdate(){
        ...
        if($recordOption==1){
            ...
            $this->db->where('idtbl_material', $recordID);
    ...
    public function Materialedit(){
        ...
        $obj=new stdClass();
        $obj->id=$respond->row(0)->idtbl_material;
        $obj->type_name=$respond->row(0)->material_type;
        $obj->code=$respond->row(0)->material_code;
